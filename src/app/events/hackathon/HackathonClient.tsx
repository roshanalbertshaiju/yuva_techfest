...
import { Cpu, Globe, Shield, Code2, Lightbulb, Rocket, ClipboardList, CheckCircle2, Zap, Users, Upload, Trophy, MapPin, Calendar } from 'lucide-react'
...
const currentLiveMilestoneIndex = 0
      ...
      <div className="relative pt-12 pb-4 z-20 max-w-7xl mx-auto px-6 text-center">
        ...
        <div className="flex justify-center gap-6 flex-wrap mb-6 border-b border-slate-900/60 pb-8 max-w-2xl mx-auto text-xs text-slate-400 font-mono">
          ...
          <div className="flex items-center gap-2">
            ...
            <span>CS Lab Block, SRM IST</span>
          </div>
          <div className="flex items-center gap-2">
            <Trophy size={14} className="text-[#ff3c00]" />
